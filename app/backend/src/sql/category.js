module.exports = {
    ...
    // 查询所有被关联的分类及其数量
    QueryCategoryAndCount:
        "SELECT c.*, COUNT(*) AS category_count FROM category c\
    ...
    GetCategoryAdminPage:
        "SELECT SQL_CALC_FOUND_ROWS c.*, GROUP_CONCAT(a_c.article_id) AS article_ids FROM category c\
